...
bar.id='lfMemberBar';
bar.innerHTML='<div class="mb-left"><a href="/docs/index.html" class="mb-brand"><img src="logo.jpg" alt="霖楓學苑" style="height:24px"></a><span id="mbGreeting"></span></div><div class="mb-right" id="mbRight"></div>';
