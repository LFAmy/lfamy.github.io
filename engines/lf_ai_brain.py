...
def _cached_call(prompt: str, role: str = "math_checker", max_tokens: int = 300, ttl: int = 1800) -> str:
    ...
    # Simplified: always use DeepSeek directly (frellmapi fixed)
    ...
    for attempt in range(2):  # max 2 attempts
        try:
            ...
            err = str(e)
            if "429" in err or "rate" in err.lower():  # 401 fixed, DeepSeek direct works
    ...
    if _OLLAMA_AVAILABLE:
        print(f"[AI Brain] DeepSeek failed, trying OllamaFreeAPI...", file=sys.stderr)
